                    ...
                    <div class="my-2 mb-0 ms-3">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-default-primary">
                                ...
                                <a class="dropdown-item" href="javascript:void(0)" data-bs-toggle="modal"
                                    data-bs-target="#exportModal" data-url="{{ route('tps.export.excel') }}">
            ...
            <div class="modal-content">
                <form action="{{ route('tps.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label required" for="dapil_id">Dapil</label>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="address" id="address" placeholder="Input address" required rows="4"></textarea>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                <form id="editForm" action="#" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label required" for="dapil_id_edit">Dapil</label>
    ...
    <script>
        $(document).ready(function() {
            $('#editModal').on('show.bs.modal', function(e) {
                ...
                var dapil_id = $(e.relatedTarget).data('dapil_id');
                var desa_id = $(e.relatedTarget).data('desa_id');

                document.getElementById("editForm").action = url;
                $('#name_edit').val(name);
                $('#address_edit').val(address);
                $('#dapil_id_edit').val(dapil_id);
