                    ...
                    <div class="my-2 mb-0 ms-3">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-default-primary">
                                ...
                                <a class="dropdown-item" href="javascript:void(0)" data-bs-toggle="modal"
                                    data-bs-target="#exportModal" data-url="{{ route('desa.export.excel') }}">
            ...
            <div class="modal-content">
                <form action="{{ route('desa.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label required" for="kecamatan_id">Kecamatan</label>
            ...
            <div class="modal-content">
                <form id="editForm" action="#" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label required" for="kecamatan_id">Kecamatan</label>
                            <select class="form-select" name="kecamatan_id" id="kecamatan_id_edit" required>
                                <option value="" selected disabled>- select kecamatan -</option>
                                @foreach ($kecamatan as $item)
                                    <option value="{{ $item->id }}">{{ $item->name }} ({{ $item->code }})</option>
                                @endforeach
