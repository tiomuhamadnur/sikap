                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="kabupaten_id" id="kabupaten_id" required>
                                <option value="" selected disabled>- select kabupaten/kota -</option>
            ...
            <div class="modal-content">
                <form id="editForm" action="#" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label required" for="kabupaten_id_edit">Kabupaten/Kota</label>
                            <select class="form-select" name="kabupaten_id" id="kabupaten_id_edit" required>
                                <option value="" selected disabled>- select kabupaten/kota -</option>
                                @foreach ($kabupaten as $item)
                                    <option value="{{ $item->id }}">{{ $item->name }} ({{ $item->code }})</option>
                                @endforeach
