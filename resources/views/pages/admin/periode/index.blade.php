            ...
            <div class="modal-content">
                <form action="{{ route('periode.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label required" for="start">Start Year</label>
                            <input type="number" min="2000" class="form-control" name="start" id="start"
                                placeholder="Input start year" autocomplete="off" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label required" for="end">End Year</label>
                            <input type="number" min="2000" class="form-control" name="end" id="end"
                                placeholder="Input end year" autocomplete="off" required>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                <form id="editForm" action="#" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label required" for="start">Start Year</label>
                            <input type="number" min="2000" class="form-control" name="start" id="start_edit"
                                placeholder="Input start year" autocomplete="off" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label required" for="end">End Year</label>
                            <input type="number" min="2000" class="form-control" name="end" id="end_edit"
                                placeholder="Input end year" autocomplete="off" required>
                        </div>
                    </div>
                    <div class="modal-footer">
